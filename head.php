...
function head($title, $extra='') {
  ...
  echo '<link rel="icon" type="image/svg+xml" href="assets/icons/favicon-accent.svg" sizes="any">';
  echo '<link rel="icon" type="image/png" href="assets/icons/favicon-accent.png">';
